...
async def apipost(req: Payload):
    ...
    data = {
		...
		"message":     "<h1 style='font-size: 30px;color: purple;'>Response<h1>\n" + f"<p style='border-left: solid green 5px; padding: 5px; background-color: #E0E0E0; color: white;'>{result}<p>",
		"status":     "success",
		"username":   "CHARLES"
    }
    print(req)
